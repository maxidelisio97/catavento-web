...
const EXPERIENCES = [
  {
    ...
    image: assetPath("images/Entrada-parque.webp"),
  },
  {
    id: "relax",
    icon: MdSpa,
    ...
    image: assetPath("images/deck y pileta.webp"),
  },
  {
    id: "natureza",
    icon: MdNature,
    ...
    image: assetPath("images/parque.webp"),
  },
  {
    id: "gastronomia",
    icon: MdRestaurant,
    ...
    image: assetPath("images/desayuno1.webp"),
  },
] as const;
      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-10">
        ...
        >
          ...
          <h2 className="font-heading text-4xl md:text-5xl font-semibold text-warm-900 leading-[0.98] tracking-tight">
            Viva Taíba<br />
            <span className="text-coral-500">de verdade</span>
          </h2>
        </motion.div>
